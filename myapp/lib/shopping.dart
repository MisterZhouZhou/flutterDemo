...
void main() => runApp(new MyShopping());
    ...
    return new MaterialApp(
      ...
      home: new ShoppingList(
        products: <Product>[
          ...
          new Product(name: 'Chocolate chips1'),
          new Product(name: 'Chocolate chips2'),
          new Product(name: 'Chocolate chips3'),
          new Product(name: 'Chocolate chips4'),
          new Product(name: 'Chocolate chips5'),
          new Product(name: 'Chocolate chips6'),
          new Product(name: 'Chocolate chips7'),
          new Product(name: 'Chocolate chips8'),
          new Product(name: 'Chocolate chips9'),
        ],
      ),
    );
  }
