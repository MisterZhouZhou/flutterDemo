...
class Company {
  ...
  static List<Company> fromJson(String jsons) {
    List<Company> resultArray = new List<Company>();
    List listArray = json.decode(jsons)['list'];
    for(Map map in listArray){
      Company job = Company.fromMap(map);
      resultArray.add(job);
    }
    return resultArray;
//    return json
