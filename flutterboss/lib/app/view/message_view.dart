...
import 'package:flutterboss/app/item/messagelist_item.dart';
import 'package:flutterboss/app/model/message.dart';
...
class MessageList extends State<MessageTab> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: new ListView.builder(
          itemCount: _messages.length, itemBuilder: (BuildContext context, int index)=>buildCompanyItem(context, index)),
    );
  }
  ...
  void getMessageList() {
    setState(() {
      _messages = [new Message(name: "小可爱", avatar: "https://img.bosszhipin.com/beijin/mcs/useravatar/20180301/17aefca1b3d0dd6c5f94409e4c1e42a2cfcd208495d565ef66e7dff9f98764da_s.jpg", company: "百度", position: "HR", msg: "你好")];
